...
public class BodyPartsManager : MonoBehaviour
{
    ...
    internal SO_CharacterBody GetCurrentCharacterBody()
    {
        return characterBody;
    }

    public void SetCharacterBody(SO_CharacterBody newcharacterBody)
    {
        if (newcharacterBody != null)
        {
            characterBody = newcharacterBody;
            ApplyCharacterBodyFromData();
        }
    }

    private void ApplyCharacterBodyFromData()
    {
        ...
        Debug.Log("Character body applied from save data");
    }
