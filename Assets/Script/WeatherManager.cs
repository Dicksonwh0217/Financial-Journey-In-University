...
public class WeatherManager : TimeAgent
{
    ...
    [SerializeField] ParticleSystem rainWithThunder;
    private void Start()
    {
        Init();
    ...
    public void RandomWeatherChangeCheck(DayTime dayTime)
    {
    ...
    private void UpdateWeather()
    {
        switch (currentWeatherState)
        {
            case WeatherStates.Clear:
                ...
                rainWithThunder.gameObject.SetActive(false);
                break;
            ...
            case WeatherStates.RainAndThunder:
                rainObject.gameObject.SetActive(false);
                heavyRainObject.gameObject.SetActive(false);
                rainWithThunder.gameObject.SetActive(true);
                break;
        }
    }
}